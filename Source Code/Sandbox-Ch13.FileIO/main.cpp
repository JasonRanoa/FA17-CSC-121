...
int main()
{
    ...
    string story = "The quick brown fox jumps over the lazy doge.";

    // Write the data and close the file
    cout << "Now writing the data to the file.\n";
    // file.write(reinterpret_cast<char *>(buffer), sizeof(buffer));
    file.write(reinterpret_cast<char *>(&story), sizeof(story));
    file.close();
    ...
    file.read(reinterpret_cast<char *>(&story), sizeof(story));
